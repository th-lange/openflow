...
export type ConfigPaths = { read: string; write: string };
 ...
 */
export async function resolveConfigPath(dir: string): Promise<ConfigPaths> {
 ...
 * empty/invalid file.
 */
export async function readConfigObject(path: string): Promise<Record<string, unknown>> {
