...
// ── create_workflow ───────────────────────────────────────────────────────────
server.tool("create_workflow", "Create or update a workflow definition in openflow.json. Validates that all referenced agents exist.", {
    ...
    const result = await createWorkflow({ name, sequence, description, commanderMayAlsoUse, force }, client, WORK_DIR);
    return { content: [{ type: "text", text: result }] };
});
// ── create_agent ──────────────────────────────────────────────────────────────
